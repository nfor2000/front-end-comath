...
const UpdateUser = ({token}) => {
     ...
     useEffect(() => {
          const fetchUser = async () => {
               try {
                    const response = await axios.get(`http://ec2-16-171-60-144.eu-north-1.compute.amazonaws.com:6666/user/me/${id}`)
     ...
     const handleSubmit = async (e) => {
          ...
          try {
               await axios.post('http://ec2-16-171-60-144.eu-north-1.compute.amazonaws.com:6666/user/update/', formData, {
                    headers: {
